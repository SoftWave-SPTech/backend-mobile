-- Base inicial para testes (inspirada no mock-api/db.json)
-- Compatível com H2 em MODE=MySQL (application-test.yml)
...
INSERT INTO usuario (
    ...
    (
        ...
        '2025-01-01T09:00:00', '2026-03-01T09:00:00'
    ),
    (
        ...
        NULL, NULL, NULL,
        '2025-02-01T09:00:00', '2026-03-01T09:00:00'
    );

INSERT INTO processo (
    id, numero_processo, descricao, area, classe, vara, foro, data_fim, categoria, created_at, updated_at
) VALUES
    (1, 'Processo 1234/2025', 'Acao civel de cobranca', 'Civel', 'Procedimento comum', '1a Vara Civel', 'Sao Paulo', NULL, 'honorarios', '2025-02-01T09:00:00', '2026-03-01T09:00:00'),
    (2, 'Processo 5678/2025', 'Consultoria contratual', 'Empresarial', 'Consultivo', '2a Vara Civel', 'Sao Paulo', NULL, 'consultoria', '2025-05-10T14:00:00', '2026-03-01T09:00:00'),
    (3, 'Processo 9012/2025', 'Acompanhamento mensal', 'Trabalhista', 'Execucao', '3a Vara do Trabalho', 'Sao Paulo', NULL, 'fixo_mensal', '2025-08-01T10:30:00', '2026-03-01T09:00:00'),
    (4, 'Processo 3456/2024', 'Contrato encerrado', 'Civel', 'Procedimento comum', '4a Vara Civel', 'Sao Paulo', '2025-01-01', 'honorarios', '2024-06-15T11:00:00', '2025-01-02T09:00:00');
...
INSERT INTO comprovante (
    ...
    (1, 1, 'comprovante_tx1.pdf', '/uploads/comprovante_tx1.pdf', '2026-03-12T14:00:00');

INSERT INTO notificacao (
    id, usuario_id, titulo, mensagem, tipo, lida, data_criacao
) VALUES
    (1, 1, 'Novo pagamento recebido', 'Joao Silva realizou o pagamento de R$ 5.000,00', 'pagamento', TRUE, '2026-03-12T16:00:00'),
    (2, 1, 'Pagamento pendente', 'Honorarios de Maria Santos vence amanha', 'alerta', TRUE, '2026-03-11T16:00:00'),
    (3, 1, 'Pagamento confirmado', 'Comprovante aprovado para o processo 1234', 'sucesso', TRUE, '2026-03-10T16:00:00'),
    (4, 2, 'Pagamento confirmado', 'Seu pagamento de R$ 6.000,00 foi confirmado', 'pagamento', FALSE, '2026-03-12T14:30:00'),
    (5, 2, 'Nova cobranca disponivel', 'Parcela de R$ 7.000,00 vence em 15/04/2026', 'cobranca', FALSE, '2026-03-12T09:15:00');
